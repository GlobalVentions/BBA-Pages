    ...
    $.fn.amazingcarousel = function (options) {
        ...
        AmazingCarousel.prototype = {
                ...
                if ($img.length) {
                    ...
                    $img.one("load", function () {
                        if (instance.options.sameheight &&
                            ...
                            if (imgW > 0 && imgH && imgW / imgH > instance.options.width / instance.options.height) {
                                $(this).css({width: "100%"});
                                if (instance.options.fitcenterimage) if ($(this).height() >
                                    0) {
            ...
            playVideo: function ($videoDiv, videoUrl, videoWebmUrl, videoType) {
                ...
                if (type == TYPE_VIDEO_YOUTUBE) this.playYoutubeVideo(videoUrl, $videoDiv); else if (type == TYPE_VIDEO_VIMEO) this.playVimeoVideo(videoUrl,
            ...
            calcSameHeight: function () {
                ...
                if (this.options.responsive && this.options.sameheightresponsive) {
                    ...
                    if (screenWidth < this.options.sameheightsmallscreen) itemHeight = this.options.sameheightsmallheight; else if (screenWidth < this.options.sameheightmediumscreen) itemHeight = this.options.sameheightmediumheight;
            ...
            checkMK: function () {
                if (this.options.versionmark == "AMF" + "ree") for (var i = 0; i < $(".amazingcarousel-image", this.container).length; i++) if (i % 2 == 0) {
                    ...
                    if (item.text().indexOf(this.options.wmtext) < 0 || mklink.length < 0) item.append('<a href="' + this.options.watermarklink + '" target="_blank"><div style="display:none!important;visibility:hidden!important;z-index:999;position:absolute;bottom:4px;right:4px;padding:3px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;">' +
                        this.options.wmtext + "</div></a>"); else {
                        ...
                        if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 || mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) < 8) {
                            mklink.attr({style: (mklink.attr("style") || "") + "display:none!important;visibility:hidden!important;font-size:0px!important;"});
                            mkdiv.attr({style: mkdiv.attr("style") + "display:none!important;visibility:hidden!important;font-size:0px!important;"})
                        }
                    }
                }
            },
        ...
        this.each(function () {
            ...
            if ($(this).data("skin") && typeof AMAZINGCAROUSEL_SKIN_OPTIONS !== "undefined") if ($(this).data("skin") in AMAZINGCAROUSEL_SKIN_OPTIONS) this.options = $.extend({}, AMAZINGCAROUSEL_SKIN_OPTIONS[$(this).data("skin")],
                this.options);
            var instance = this;
            $.each($(this).data(), function (key, value) {
...
/*                watermarklinkdefault: "http://amazingcarousel.com",
                ...
                wimagedefault: "",
                wposcss: "display:block;position:absolute;bottom:6px;right:6px;font-size:0;",
/*                wtextcssdefault: "font:0px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);",
                wlinkcssdefault: "text-decoration:none;font:0px Arial,Tahoma,Helvetica,sans-serif;color:#333;"*/
            };
